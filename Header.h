...
struct BootSector {
	...
	int32 RDET_cluster = 2;	//cluster bat dau cua RDET
	int32 FAT_empty = 3;	//vi tri trong cua bang FAT
	int8 raw[490] = { 0 };
};
struct FAT_table {
	vector<int32> Fat;
